...
var _createRole = require("../../middlewares/validation/createRole");

var _users_roles = require("../../controllers/admin/users_roles");

var _changeUserRole = require("../../middlewares/changeUserRole");
...
router.get('/roles', _users_roles.getAllRoles);
/* create a new role  */
...
router.post('/roles', _createRole.roleValidation, _users_roles.createRole);
...
router.put('/roles/update', _createRole.updateValidation, _users_roles.updatePermissions);
/* delete a role */
...
router["delete"]('/roles', _createRole.deleteValidation, _users_roles.deleteRoles);
/* retrieve all users */
...
router.get('/users', _users_roles.findUsers);
/* update a user role */
...
router.put('/users', _createRole.updateUserRoleValidation, _users_roles.updateUserRole); // when you change a requester as a manager, then add him also to the line_manager table and also change so that we will update the primary key not the name of the role
...
router.put('/users/line-manager', (0, _accessControl["default"])(['assign requesters to manager']), _createRole.assignLineManagerValidation, _users_roles.assignLineManager);
/* delete one user */
...
router["delete"]('/users', _createRole.deleteValidationEmail, _changeUserRole.changeUserRole, _users_roles.deleteOne);
