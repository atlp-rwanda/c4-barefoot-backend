...
router.get('/', (0, _accessControl["default"])(['view accommodations']), _accommodations.getAccommodations);
/**
 * @swagger
 *
...
router.get('/:id', (0, _accessControl["default"])(['view accommodations']), _accommodations.getOneAccommodation);
/**
 * @swagger
 *
 * /api/v1/accommodations/{id}:
...
router.patch('/:id', (0, _accessControl["default"])(['update accommodations']), _accommodations.updateAccommodation);
/**
 * @swagger
 *
 * /api/v1/accommodations/{id}:
...
router["delete"]('/:id', (0, _accessControl["default"])(['delete accommodations']), _accommodations.deleteAccommodation);
/**
 * @swagger
 *
 * /api/v1/accommodations:
...
router.post('/', (0, _accessControl["default"])(['create accommodations']), _accommodations.createAccommodation);
/**
 * @swagger
 *
...
router.post('/book/:id', (0, _accessControl["default"])(['book accommodations']), _accommodations.bookAccomodation);
var _default = router;
